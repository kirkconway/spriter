...
public class SlickTest extends BasicGame{
    ...
    public void init(GameContainer gc)
		...
		spriterAnimation = SpriterAnimation.createAnimation("monster/basic.scml", loader);
		List<SpriterKeyFrame[]> keyframes = SpriterKeyFrameProvider.generateKeyFramePool(spriterAnimation.getSpriterData());
		spriterPlayer = new SpriterPlayer(spriterAnimation.getSpriterData(), new ImageDrawer(loader,800,g), keyframes);
